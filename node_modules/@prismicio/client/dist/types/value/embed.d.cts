import { EmptyObjectField, FieldState } from "./types.cjs";

//#region src/types/value/embed.d.ts
 ...
 * @see oEmbed specification: {@link https://oembed.com}
 */
type PhotoOEmbed = OEmbedBase<typeof OEmbedType.Photo> & {
  /**
 ...
 * @see oEmbed specification: {@link https://oembed.com}
 */
type VideoOEmbed = OEmbedBase<typeof OEmbedType.Video> & {
  /**
 ...
 * @see oEmbed specification: {@link https://oembed.com}
 */
type LinkOEmbed = OEmbedBase<typeof OEmbedType.Link>;
/**
 ...
 * @see oEmbed specification: {@link https://oembed.com}
 */
type RichOEmbed = OEmbedBase<typeof OEmbedType.Rich> & {
  /**
 ...
 * @see oEmbed specification: {@link https://oembed.com}
 */
type AnyOEmbed = PhotoOEmbed | VideoOEmbed | LinkOEmbed | RichOEmbed;
/**
 * An embed field.
 *
 ...
 */
type EmbedField<Data extends AnyOEmbed = AnyOEmbed & OEmbedExtra, State extends FieldState = FieldState> = State extends "empty" ? EmptyObjectField : Data & {
  embed_url: string;
  html: string | null;
};
//#endregion
export { AnyOEmbed, EmbedField, LinkOEmbed, OEmbedExtra, OEmbedType, PhotoOEmbed, RichOEmbed, VideoOEmbed };
