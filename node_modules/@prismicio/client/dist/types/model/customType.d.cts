import { CustomTypeModelField } from "./types.cjs";

//#region src/types/model/customType.d.ts
 ...
 */
type CustomTypeModelDefinition<TabName extends string = string> = Record<TabName, CustomTypeModelTab>;
/**
 ...
 */
type CustomTypeModelTab<Fields extends Record<string, CustomTypeModelField> = Record<string, CustomTypeModelField>> = Fields;
//#endregion
export { CustomTypeModel, CustomTypeModelDefinition, CustomTypeModelTab };
