 ...
 */
declare const getToolbarSrc: <TRepositoryName extends string>(repositoryName: TRepositoryName) => `https://static.cdn.prismic.io/prismic.js?new=true&repo=${TRepositoryName}`;
//#endregion
export { getToolbarSrc };
//# sourceMappingURL=getToolbarSrc.d.cts.map