...
import { projectenTijdlijn } from '@/data/portfolio-chart-data'
...
export default {
  name: 'ProjectenGanttChart',
  components: { Bar },
  data() {
    const items = projectenTijdlijn
    ...
    return {
      ...
      chartOptions: {
        ...
        plugins: {
          title: { display: true, text: 'Projecten bij Bulbmanager', font: { size: 16 } },
